...
{
    public class createFireThrower : MonoBehaviour
    {
        ...
        void Update()
        {
            currentPrefabObject.transform.position = transform.position + transform.forward + transform.up;
        ...
        private void BeginEffect()
        {
            ...
            currentPrefabScript.Duration = 100000; //讓他變成永遠
            currentPrefabScript.AudioSource.enabled = false; //去除音效
